...
train_directory = "C:/Users/KSS THANMAI/Desktop/3RD YEAR/FaceRecognition/images/train"  # Update with the path to your training data folder
validation_directory = "C:/Users/KSS THANMAI/Desktop/3RD YEAR/FaceRecognition/images/validation"  # Update with the path to your validation data folder
...
emotion_model.save(model_filename)
print(f"Model saved as {model_filename}")

# Evaluate the model on the test set
test_directory = "C:/Users/KSS THANMAI/Desktop/3RD YEAR/FaceRecognition/images/train"  # Update with the path to your test data folder
